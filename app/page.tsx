...
const defaultState: StudioState = {
  title: "Grid Studio",
  description: "Native grid pattern with preview/export-honest controls.",
  label: "Grid",
  value: "grid",
...
const presets: Preset[] = [
  ...
  { family: "layout", archetype: "Commerce", variant: "hero", size: "spacious", tags: ["commerce", "bold"], state: { ...defaultState, title: "Conversion Grid", accent: "#fb7185", background: "#1e1b4b", width: 420, height: 220, shadow: 36 } },
];
    ...
    <main className="mx-auto grid min-h-screen max-w-[1500px] gap-6 px-5 py-6 lg:grid-cols-[430px_1fr]">
      <aside className="space-y-5">
        <header className="rounded-[2rem] border border-white/10 bg-slate-950/70 p-5 shadow-2xl shadow-black/30">
          ...
          <h1 className="mt-3 text-3xl font-black tracking-tight">Grid Studio</h1>
          <p className="mt-2 text-sm text-slate-400">Self-contained, React-only, buyer-ready grid generator.</p>
        </header>
